...
var Notify = {
    ...
    timer : null, //
    init: function () {
        this.$wrapper = $('<div class="notify-wrapper"><div class="notify-window" style="padding: 0;"><h3></h3><p></p><div class="buttons"><button class="ok">確認</buton><button class="cancel">取消</buton></div></div></div>');
